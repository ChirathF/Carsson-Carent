      ...
      <form action=""method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter address" name="address_staff" required>
          </div>
          <div class="input-box">
...
if (isset($_POST['addStaff'])) {
  ...
  $insertStaff = "INSERT INTO staff(fName,lName,NIC,contactNo,address,email,type,picture,userName,password)" . "VALUES ('$firstName', '$lastName', '$nic', '$contactNo', '$address_staff', '$email', '$post', '$uploadImage', '$username', '$password' )";

  $runStaff = mysqli_query($conn, $insertStaff);

  if ($runStaff) {
    echo "<script> alert('Staff Added Successfully ')</script>";
    echo "<script> window.open('index.php?addStaff ','_self')</script>";
}
}
